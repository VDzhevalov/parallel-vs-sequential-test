package com.vdzhevalov.executionmodes.tests.parallelconcurrent.inline;
...
@Tag("CONCURRENT_Inline")
@TestInstance(TestInstance.Lifecycle.PER_METHOD)
@Execution(CONCURRENT)
public class InlineParallelConcurrentPerMethodTests2 extends RemotePerMethodSetup {

    static final String DESCRIPTION = "ExecutionMode.CONCURRENT; TestInstance.Lifecycle.PER_METHOD; Inline";
