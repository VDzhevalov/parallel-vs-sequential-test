package com.vdzhevalov.executionmodes.tests.parallelconcurrent.readfromfile;
...
@Tag("CONCURRENT_FromFile")
@TestInstance(TestInstance.Lifecycle.PER_METHOD)
@Execution(CONCURRENT)
public class ReadFromFileParallelConcurrentPerMethodTests2 extends RemotePerMethodSetup {
    static final String DESCRIPTION = "ExecutionMode.CONCURRENT; TestInstance.Lifecycle.PER_METHOD";
