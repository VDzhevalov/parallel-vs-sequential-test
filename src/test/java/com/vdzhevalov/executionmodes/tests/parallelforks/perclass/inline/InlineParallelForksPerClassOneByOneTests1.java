package com.vdzhevalov.executionmodes.tests.parallelforks.perclass.inline;
...
@Tag("parallelFork_PER_CLASS_Inline")
@TestInstance(TestInstance.Lifecycle.PER_CLASS)
@Execution(SAME_THREAD)
public class InlineParallelForksPerClassOneByOneTests1 extends RemotePerClassSetup {
    static final String DESCRIPTION = "ParallelFork ExecutionMode.SAME_THREAD; TestInstance.Lifecycle.PER_CLASS; Inline";
