package com.vdzhevalov.executionmodes.tests.parallelforks.perclass.readfromfile;
...
import com.vdzhevalov.executionmodes.setup.remote.RemotePerClassSetup;
...
@Tag("parallelFork_PER_CLASS_FromFile")
@TestInstance(TestInstance.Lifecycle.PER_CLASS)
@Execution(SAME_THREAD)
public class ReadFromFileParallelForksPerClassOneByOneTests1 extends RemotePerClassSetup {

    static final String DESCRIPTION = "ParallelFork ExecutionMode.SAME_THREAD; TestInstance.Lifecycle.PER_CLASS";
