package com.vdzhevalov.executionmodes.tests.onebyone.permethod.inline;
...
@Tag("oneByOne_PER_METHOD_Inline")
@TestInstance(TestInstance.Lifecycle.PER_METHOD)
@Execution(SAME_THREAD)
public class InlinePerMethodOneByOneTests1 extends RemotePerMethodSetup {

    static final String DESCRIPTION = "ExecutionMode.SAME_THREAD; TestInstance.Lifecycle.PER_METHOD; Inline";
