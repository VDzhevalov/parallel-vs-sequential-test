package com.vdzhevalov.executionmodes.tests.onebyone.perclass.readfromfile;
...
@Tag("oneByOne_PER_CLASS_FromFile")
@TestInstance(TestInstance.Lifecycle.PER_CLASS)
@Execution(SAME_THREAD)
public class ReadFromFilePerClassOneByOneTests2 extends RemotePerClassSetup {
    static final String DESCRIPTION = "ExecutionMode.SAME_THREAD; TestInstance.Lifecycle.PER_CLASS";
