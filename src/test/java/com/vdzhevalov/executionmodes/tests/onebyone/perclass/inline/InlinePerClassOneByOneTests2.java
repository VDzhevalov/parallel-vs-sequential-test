package com.vdzhevalov.executionmodes.tests.onebyone.perclass.inline;
...
@Tag("oneByOne_PER_CLASS_Inline")
@TestInstance(TestInstance.Lifecycle.PER_CLASS)
@Execution(SAME_THREAD)
public class InlinePerClassOneByOneTests2 extends RemotePerClassSetup {

    static final String DESCRIPTION = "ExecutionMode.SAME_THREAD; TestInstance.Lifecycle.PER_CLASS; Inline";
